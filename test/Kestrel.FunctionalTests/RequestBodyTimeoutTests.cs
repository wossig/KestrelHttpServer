...
namespace Microsoft.AspNetCore.Server.Kestrel.FunctionalTests
{
    public class RequestBodyTimeoutTests
    {
        ...
        public async Task RequestTimesOutWhenNotDrainedWithinDrainTimeoutPeriod()
        {
            ...
            Assert.Contains(sink.Writes, w => w.EventId.Id == 32 && w.LogLevel == LogLevel.Information);
            Assert.Contains(sink.Writes, w => w.EventId.Id == 33 && w.LogLevel == LogLevel.Information);
        }
